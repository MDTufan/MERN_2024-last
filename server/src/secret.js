...
const forget_Password = process.env.FORGET_PASSWORD || "hiugyshjjsggs5s";
...
module.exports={SERVER_PORT,mongobd_url,defaultImagePath,jwt_Key,smtp_username,smtp_password,clind_url,ACCESS_TOKEN_KEY,forget_Password};